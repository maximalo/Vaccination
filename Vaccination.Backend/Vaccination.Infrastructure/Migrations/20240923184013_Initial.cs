        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { Guid.NewGuid().ToString(), "READ", "READ", Guid.NewGuid().ToString() },
                    { Guid.NewGuid().ToString(), "WRITE", "WRITE", Guid.NewGuid().ToString() },
                    { Guid.NewGuid().ToString(), "DELETE", "DELETE", Guid.NewGuid().ToString() }
                });
        }
